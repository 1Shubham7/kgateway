...
func TestRouteReplacement(t *testing.T) {
	...
	common.SetupBaseConfig(ctx, t, testInstallation, filepath.Join("..", "features", "routereplacement", "testdata", "setup.yaml"))
	common.SetupDefaultBaseGateway(ctx, testInstallation)
